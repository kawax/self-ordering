...
Before creating a component, check `config/livewire.php` for directory overrides, which change where files are stored. Then, look at existing files in those directories (defaulting to `vendor/orchestra/testbench-core/laravel/app/Livewire/` and `resources/views/livewire/`) to match the established convention.
...
| Multi-file (MFC) | `--mfc` | `vendor/orchestra/testbench-core/laravel/app/Livewire/CreatePost.php` | `resources/views/livewire/create-post.blade.php` |
| Class-based | `--class` | `vendor/orchestra/testbench-core/laravel/app/Livewire/CreatePost.php` | `resources/views/livewire/create-post.blade.php` |
| View-based | ⚡ prefix | — | `resources/views/livewire/create-post.blade.php` (Blade-only with functional state) |

Namespaced components map to subdirectories: `make:livewire Posts/CreatePost` creates files at `vendor/orchestra/testbench-core/laravel/app/Livewire/Posts/CreatePost.php` and `resources/views/livewire/posts/create-post.blade.php`.
